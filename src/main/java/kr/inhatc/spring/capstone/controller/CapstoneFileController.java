...
import kr.inhatc.spring.capstone.dto.CapstoneFileRequestDto;
import kr.inhatc.spring.capstone.dto.CapstoneFileResponseDto;
import kr.inhatc.spring.capstone.service.CapstoneFileService;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Controller
public class CapstoneFileController {
    ...
    public void downloadFile(@RequestParam() Long id, HttpServletResponse response) throws Exception {
        try {
            // 파일정보를 조회한다.
            CapstoneFileResponseDto fileInfo = capstoneFileService.findById(id);
    ...
    public String updateDeleteYn(Model model, CapstoneFileRequestDto capstoneFileRequestDto) throws Exception {
        try {
            model.addAttribute("result", capstoneFileService.updateDeleteYn(capstoneFileRequestDto.getIdArr()));
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        }
